  ...
  const problems = [
    {
      ...
      description:
        "Não consigo fazer login na minha conta. Recebo uma mensagem de erro de credenciais inválidas.",
      resolution:
    ...
    },
    {
      ...
      description:
        "As páginas do site estão carregando lentamente ou apresentando erros de carregamento.",
      resolution:
    ...
    },
    {
      ...
      description:
        "Não consigo criar na minha conta. Recebo uma mensagem de erro de error ao conectar ao servidor.",
      resolution:
        'Certifique-se de inserir as credenciais corretas. Verifique se a tecla Caps Lock está desligada. Se você esqueceu sua senha, clique em "Esqueci minha senha" para redefini-la.',
    },
    {
      ...
      description:
        "Não consigo avaliar uma questão. Recebo uma mensagem de erro de error ao conectar ao servidor.",
      resolution:
    ...
    },
    {
      ...
      description:
        "Não consigo visualizar uma questão. Recebo uma mensagem de erro de error ao conectar ao servidor.",
      resolution:
        'Certifique-se de está conectado à internet. Verifique se a tecla Caps Lock está desligada. Se você esqueceu sua senha, clique em "Esqueci minha senha" para redefini-la.',
    },
  ];
